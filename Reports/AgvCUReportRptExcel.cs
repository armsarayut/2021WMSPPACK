...
{
    public class AgvCUReportRptExcel
    {
        ...
        public byte[] Report(List<Vrptqueueloadtimeagv> ListRpt)
        {
            ...
            {
                var worksheet = workbook.AddWorksheet("10.9");
                int startRows = 4;
                ...
                image.ScaleWidth(.35);
                image.ScaleHeight(.2);
                worksheet.Cell("B1").Value = "10.9.AGV" + " Report";
                ...
                worksheet.Cell(rptRows, 9).Value = "TYPE";
                worksheet.Cell(rptRows, 10).Value = "MODE";
                ...
                foreach (var rpt in ListRpt)
                {
                    ...
                    worksheet.Cell(rptRows, 9).Value = rpt.Work_code;
                    worksheet.Cell(rptRows, 10).Value = rpt.Work_mode;
                }
                #endregion
